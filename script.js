...
function openDashboard() {
    ...
    if (password === 'tribu2024') {
        // Per ora apre una pagina vuota, da implementare il dashboard
        alert('Dashboard in sviluppo! Contatta Andrea per accedere ai dati.');
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Andrea Padoan Landing - Loading...');
